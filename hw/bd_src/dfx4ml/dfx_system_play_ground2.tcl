...
source [file join $project_root bd_src dfx4ml dfx4ml.tcl]
...
#eate_dfx_region_bd $parentCell "dfx_pr_0" $clk_frq \
#                   $num_dfx_streamer $interface_widths \
#                   $input_maps $output_maps \
#                   $ip_src

#eate_dfx_region_bd $parentCell "dfx_pr_1" $clk_frq \
#                   $num_dfx_streamer $interface_widths \
#                   $input_1_maps $output_1_maps \
#                   $ip_src

#eate_dfx_unified_bd $parentCell $clk_frq $rm_index_width \
#                    $num_dfx_streamer $interface_widths \
...
create_dfx4ml_design $parentCell $clk_frq $rm_index_width \
                     $num_dfx_streamer $interface_widths \
                     $applied_interface_widths $storage_index_widths \
                     $num_actual_rm $input_map_list $output_map_list \
                     $ip_map_list $test_mode $create_new_block