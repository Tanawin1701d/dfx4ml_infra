...
proc create_kv260_dfx4ml_design { parentCell \
    ...
    connect_bd_intf_net -boundary_type upper -intf_net dfx_unified_0_M_AXI_DMA_IN [get_bd_intf_pins dfx_unified_0/M_AXI_DMA_IN] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
    connect_bd_intf_net -boundary_type upper -intf_net dfx_unified_0_M_AXI_BS     [get_bd_intf_pins dfx_unified_0/M_AXI_BS]     [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
    connect_bd_intf_net -intf_net dfx_unified_0_M_AXI_DMA_OUT [get_bd_intf_pins dfx_unified_0/M_AXI_DMA_OUT] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC1_FPD]
    connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins dfx_unified_0/S_AXI_CTRL]
    connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins smartconnect_1/M01_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
    ...
    connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins dfx_unified_0/nreset] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn]
    set clk_pins [list \
    ...
    assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/DFX_Ctrl_B/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
    assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/DFX_Ctrl_B/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
    assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/dma_hier/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
    ...
    for {set r 0} {$r < $num_dfx_region} {incr r} {
        ...
        # query the PR-ctrl segment via the region's S_AXI_LITE_PR_CTRL interface pin so
        # this works for both test mode (AXI_Lite_Shut_0/S_AXI) and user mode
        # (kernel_0/s_axi_control) without hardcoding the inner IP name.
        assign_bd_address -offset $pr_ctrl_offset -range 0x00010000 \
            ...
            [get_bd_addr_segs -of_objects [get_bd_intf_pins dfx_pr_region_${r}_0/S_AXI_LITE_PR_CTRL]] -force
    }
    ...
    for {set r 0} {$r < $num_dfx_region} {incr r} {
        set pr_ctrl_offset [format 0x%08X [expr {0xA0050000 + $r * 0x00010000}]]
        # same generic lookup as the DFX_Mng/M_AXI loop above (mode-agnostic).
        assign_bd_address -offset $pr_ctrl_offset -range 0x00010000 \
    ...
    exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces dfx_unified_0/DFX_Ctrl_B/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
    exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/DFX_Ctrl_B/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
    exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces dfx_unified_0/dma_hier/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
    exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/dma_hier/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
    exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces dfx_unified_0/dma_hier/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_HIGH]
    exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dfx_unified_0/dma_hier/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
